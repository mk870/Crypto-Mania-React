...
import { exchangesOptions } from "../../components/ApiOptions/ExchangesOptions";
        ...
        return (
          <div className="card" key={index}>
            <a href={exchange.url} target="_blank" rel="noreferrer">
              ...
              <div className="year">{exchange.year_established || "NULL"}</div>
              <div className="score">{exchange.trust_score}</div>
